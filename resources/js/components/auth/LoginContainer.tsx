...
export default function LoginContainer() {
    ...
    const proceedLogin = (event: FormEvent<HTMLFormElement>) => {
        ...
        const passwordCheck = validateInput(
            passwordRef.current,
        ...
        login({
            ...
            .then(result => {
                if (result.success) {
                    ...
                    setErrorAlert({
                        shouldDisplay: true,
                        message: errorMap.get(result.error),
                    });
            ...
            .catch(err => {
                ...
                setErrorAlert({
                    shouldDisplay: true,
                    message: "Error while communicating with backend !",
                });
            })
            .finally(() => {
                setSubmitting(false);
        ...
        <form onSubmit={proceedLogin} noValidate>
            <div className="d-flex justify-content-center align-items-center vh-100 flex-column">
                ...
                <div className="form-check mt-1">
                    <input
                        className="form-check-input mt-3 bg-dark border-secondary"
                        type="checkbox"
                        value=""
                        id="rememberMe"
